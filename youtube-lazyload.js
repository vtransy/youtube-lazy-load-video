...
(function(){
    ...
    var youtube = document.querySelectorAll('.yt-lazyload'),
        ...
        settings_thumb_base_url         = 'https://i.ytimg.com/vi_webp/',     //Base URL where thumbnails are stored
        ...
        youtube_observer = new IntersectionObserver(function(elements){
            ...
            elements.forEach(function(e){
                ...
                if(e.isIntersecting === true){
                    ...
                    //background-image
                    this_content.style.setProperty('--yt-lazyload-img','url("' + settings_thumb_base_url + this_data_id + '/maxresdefault' + '.' + settings_thumb_extension + '")');
